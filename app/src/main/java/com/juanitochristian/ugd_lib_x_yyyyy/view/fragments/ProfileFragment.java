...
import com.juanitochristian.ugd_lib_x_yyyyy.databinding.FragmentProfileBinding;
import com.juanitochristian.ugd_lib_x_yyyyy.view.MainViewModel;
import com.juanitochristian.ugd_lib_x_yyyyy.view.QRScannerActivity;
                        ...
                        public void onActivityResult(ActivityResult result) {
                            if (result.getResultCode() == Activity.RESULT_OK) {
                                try {
                                    ...
                                    String QResult = intent.getStringExtra("QR_RESULT");

                                    viewModel.scanQRUserProfile(QResult);
                                } catch (Exception e) {
                                    Toast.makeText(requireContext(), "QR CODE TIDAK VALID!", Toast.LENGTH_SHORT).show();
                                    viewModel.setScan(false);
                                }
                            }
                        }
                    });
